...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kajur'); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kajur/presensi'); ?>">
      <i class="fas fa-fw fa-list-alt"></i>
      <span>Presensi Keseluruhan</span></a>
  </li>

  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kajur/grafik'); ?>">
      <i class="fas fa-fw fa-list-alt"></i>
      <span>Grafik</span></a>
  </li>
