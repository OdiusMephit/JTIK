...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Nav Item - Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kps'); ?>">
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kps/perizinan'); ?>">
      <i class="fas fa-fw fa-list-alt"></i>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kps/kehadiran_mahasiswa'); ?>">
      <i class="fas fa-fw fa-list-alt"></i>
      <span>Kehadiran Mahasiswa</span></a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" href="<?= base_url('kps/upload_jadwal'); ?>">
      <i class="fas fa-fw fa-calendar-alt"></i>
